...
class Irrigatech2SupabaseUser extends BaseAuthUser {
  Irrigatech2SupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> irrigatech2SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Irrigatech2SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
